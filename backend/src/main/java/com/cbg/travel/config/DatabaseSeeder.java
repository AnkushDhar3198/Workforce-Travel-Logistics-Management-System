...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Expense exp1 = Expense.builder()
                ...
                .category("HOTEL")
                .amount(1500.0)
                .receiptUrl("http://localhost:8080/uploads/london_hotel_receipt.png")
        ...
        Expense exp2 = Expense.builder()
                ...
                .receiptUrl("http://localhost:8080/uploads/dinner_receipt.png")
        ...
        Expense exp3 = Expense.builder()
                ...
                .category("TRANSPORT")
                .amount(65.0)
                .receiptUrl("http://localhost:8080/uploads/uber_receipt.png")
        ...
        Document doc1 = Document.builder()
                ...
                .type("PASSPORT")
                .fileUrl("http://localhost:8080/uploads/passport_bob.pdf")
                .expiryDate(LocalDate.now().plusDays(10)) // expiring soon warning!
                .build();
        Document doc2 = Document.builder()
                .userId(employee.getId())
                .type("VISA")
                .fileUrl("http://localhost:8080/uploads/visa_uk_bob.pdf")
